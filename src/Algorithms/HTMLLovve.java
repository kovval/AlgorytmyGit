...
public class HTMLLovve extends AbstractAlgorithm {
    ...
    // jak ktos wrzuci ptaszka do tekstu to niestety spartoli dzialanie programu, a przez to zjebie tekst
    // na stronie HTML, dlatego tez te zadanie nie moze zostac wykorzystane w praktyznym wykorystaniu do
    // momentu wyeliminowania ptaszkowego problemu.
        // tekst w ptaszkach nie moze miec przerw w psotaci spacji " "
        // mozna by to rozwiazac jakim repleacem ale nei mam czasu tyle co by nie przyklady sie zgadzaja
